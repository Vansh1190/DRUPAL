...
class __TwigTemplate_7912923dc6c9ac9d911d362bf50d4f86 extends Template
{
    private $source;
    private $macros = [];
...
";
  ...
  <div class=\"container\">
    <div class=\"header-container\">
      ";
        ...
        if (twig_get_attribute($this->env, $this->source, ($context["page"] ?? null), "header", [], "any", false, false, true, 17)) {
          ...
          ";
            // line 19
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->extensions['Drupal\gin_lb\TwigExtension\GinLbExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["page"] ?? null), "header", [], "any", false, false, true, 19), 19, $this->source), "html", null, true));
            echo "
        </div> <!--/.site-branding -->
      ";
        }
        ...
        ";
            ...
            <div class=\"menu-wrap\">
              ...
              ";
                // line 29
                echo $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->extensions['Drupal\gin_lb\TwigExtension\GinLbExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["page"] ?? null), "primary_menu", [], "any", false, false, true, 29), 29, $this->source), "html", null, true));
                echo "
            </div> <!-- /.menu-wrap -->
    ...
    {
        return new Source("", "@edux/template-parts/header/header.html.twig", "C:\\xampp\\htdocs\\causmic2\\themes\\edux\\templates\\template-parts\\header\\header.html.twig");
    }

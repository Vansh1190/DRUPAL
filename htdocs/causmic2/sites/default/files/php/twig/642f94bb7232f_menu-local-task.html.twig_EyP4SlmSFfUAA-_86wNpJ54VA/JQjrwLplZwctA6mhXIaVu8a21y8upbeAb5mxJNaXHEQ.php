...
class __TwigTemplate_a08bfb7b9d8a3e2273c6e01ff45d772a extends Template
{
    private $source;
    private $macros = [];
...
($context["is_active"] ?? null)) ? ("active") : (""))];
  ...
  ";
        // line 24
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->extensions['Drupal\gin_lb\TwigExtension\GinLbExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["link"] ?? null), 24, $this->source), "html", null, true));
        echo "
  ";
        // line 25
      ...
      <span class=\"visually-hidden\">";
            // line 27
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->extensions['Drupal\Core\Template\TwigExtension']->renderVar(t("Toggle tabs as a menu")));
            echo "</span>
    </a>
  ";
        }
...
";
    ...
    {
        return new Source("", "themes/bootstrap5/templates/navigation/menu-local-task.html.twig", "C:\\xampp\\htdocs\\causmic2\\themes\\bootstrap5\\templates\\navigation\\menu-local-task.html.twig");
    }

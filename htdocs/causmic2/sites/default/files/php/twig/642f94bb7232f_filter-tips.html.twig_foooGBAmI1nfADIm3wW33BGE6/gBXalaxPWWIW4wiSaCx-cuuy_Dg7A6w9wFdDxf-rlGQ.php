...
class __TwigTemplate_e6ea2b598faf9600f606169099297547 extends Template
{
    private $source;
    private $macros = [];
...
$context["name"], 33, $this->source)))];
      ...
      <h3>";
                    // line 37
                    echo $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->extensions['Drupal\gin_lb\TwigExtension\GinLbExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["tip"], "name", [], "any", false, false, true, 37), 37, $this->source), "html", null, true));
                    echo "</h3>
    ";
                }
                // line 39
...
($context["long"] ?? null)) ? (("filter-" . twig_replace_filter($this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["item"], "id", [], "any", false, false, true, 45), 45, $this->source), ["/" => "-"]))) : (""))];
                        ...
                        echo ">";
                        echo $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->extensions['Drupal\gin_lb\TwigExtension\GinLbExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["item"], "tip", [], "any", false, false, true, 48), 48, $this->source), "html", null, true));
                        echo "</li>
      ";
                    }
  ...
  ";
    ...
    {
        return new Source("", "themes/bootstrap5/templates/content-edit/filter-tips.html.twig", "C:\\xampp\\htdocs\\causmic2\\themes\\bootstrap5\\templates\\content-edit\\filter-tips.html.twig");
    }

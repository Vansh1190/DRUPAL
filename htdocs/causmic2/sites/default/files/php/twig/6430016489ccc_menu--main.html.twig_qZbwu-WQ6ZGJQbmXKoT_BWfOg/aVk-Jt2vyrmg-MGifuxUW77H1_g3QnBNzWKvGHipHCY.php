...
class __TwigTemplate_957f8283cd80c1945ebd5bc1c1b81cc0 extends Template
{
    private $source;
    private $macros = [];
...
";
        // line 27
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->extensions['Drupal\Core\Template\TwigExtension']->renderVar(twig_call_macro($macros["menus"], "macro_build_menu", [($context["items"] ?? null), ($context["attributes"] ?? null), 0], 27, $context, $this->getSourceContext())));
        echo "
...
($context["menu_level"] ?? null), 36, $this->source))];
                // line 39
                echo "    <ul";
                echo $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->extensions['Drupal\gin_lb\TwigExtension\GinLbExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["attributes"] ?? null), "addClass", [0 => ($context["ul_classes"] ?? null)], "method", false, false, true, 39), 39, $this->source), "html", null, true));
                echo ">
    ";
                // line 40
...
($context["menu_level"] ?? null) > 0)) ? ("dropdown-item") : (""))];
    ...
    ";
      ...
      ";
                // line 70
                echo $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->extensions['Drupal\Core\Template\TwigExtension']->renderVar(twig_call_macro($macros["menus"], "macro_build_menu", [twig_get_attribute($this->env, $this->source, ($context["item"] ?? null), "below", [], "any", false, false, true, 70), ($context["attributes"] ?? null), (($context["menu_level"] ?? null) + 1)], 70, $context, $this->getSourceContext())));
                echo "
    ";
            } else {
                // line 72
...
";
    ...
    {
        return new Source("", "themes/bootstrap5/templates/navigation/menu--main.html.twig", "C:\\xampp\\htdocs\\causmic2\\themes\\bootstrap5\\templates\\navigation\\menu--main.html.twig");
    }

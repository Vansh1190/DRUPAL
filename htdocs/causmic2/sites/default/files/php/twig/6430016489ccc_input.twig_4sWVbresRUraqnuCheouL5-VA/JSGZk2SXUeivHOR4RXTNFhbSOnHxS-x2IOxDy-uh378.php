...
class __TwigTemplate_b6b011cc078280687193adfac516dc3c extends Template
{
    private $source;
    private $macros = [];
...
<input";
        // line 23
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->extensions['Drupal\gin_lb\TwigExtension\GinLbExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["attributes"] ?? null), "addClass", [0 => ($context["input_classes"] ?? null)], "method", false, false, true, 23), 23, $this->source), "html", null, true));
        echo " />";
...
";
    ...
    {
        return new Source("", "@radix/form/input.twig", "themes/radix/src/components/form/input.twig");
    }

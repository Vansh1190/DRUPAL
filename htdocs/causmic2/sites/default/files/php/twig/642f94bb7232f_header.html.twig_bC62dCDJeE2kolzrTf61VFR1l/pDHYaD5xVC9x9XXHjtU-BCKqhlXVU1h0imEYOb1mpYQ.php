...
class __TwigTemplate_4843ab5cf1069638bd81d3d8d274ca63 extends Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"header-container\">
      ";
        ...
        if (twig_get_attribute($this->env, $this->source, ($context["page"] ?? null), "header", [], "any", false, false, true, 15)) {
          ...
          ";
            // line 17
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->extensions['Drupal\gin_lb\TwigExtension\GinLbExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["page"] ?? null), "header", [], "any", false, false, true, 17), 17, $this->source), "html", null, true));
            echo "
        </div> <!--/.site-branding -->
      ";
        }
        ...
        ";
            ...
            <div class=\"menu-wrap\">
              ...
              ";
                // line 27
                echo $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->extensions['Drupal\gin_lb\TwigExtension\GinLbExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["page"] ?? null), "primary_menu", [], "any", false, false, true, 27), 27, $this->source), "html", null, true));
                echo "
            </div> <!-- /.menu-wrap -->
...
($context["is_front"] ?? null) && twig_get_attribute($this->env, $this->source, ($context["page"] ?? null), "page_header", [], "any", false, false, true, 41))) {
    ...
    {
        return new Source("", "@xara/template-parts/header.html.twig", "C:\\xampp\\htdocs\\causmic2\\themes\\xara\\templates\\template-parts\\header.html.twig");
    }

...
/* @radix/nav/nav.twig */
class __TwigTemplate_f664974a1471efc7372550f7f6587874 extends Template
{
    private $source;
    private $macros = [];
...
";
        ...
        if (($context["items"] ?? null)) {
            // line 31
            echo "  <ul";
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->extensions['Drupal\gin_lb\TwigExtension\GinLbExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["attributes"] ?? null), "addClass", [0 => ($context["nav_classes"] ?? null)], "method", false, false, true, 31), 31, $this->source), "html", null, true));
            echo ">
    ";
            // line 32
...
$context["item"], "below", [], "any", false, false, true, 50)]));
    ...
    {
        return new Source("", "@radix/nav/nav.twig", "themes/radix/src/components/nav/nav.twig");
    }

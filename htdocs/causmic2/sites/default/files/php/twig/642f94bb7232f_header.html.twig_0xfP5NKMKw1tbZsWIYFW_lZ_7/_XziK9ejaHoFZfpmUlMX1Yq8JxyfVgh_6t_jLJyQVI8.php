...
class __TwigTemplate_8933831fab96b7b0414a74da34dfe222 extends Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"header-container\">
      ";
        ...
        if (twig_get_attribute($this->env, $this->source, ($context["page"] ?? null), "header", [], "any", false, false, true, 4)) {
          ...
          ";
            // line 6
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->extensions['Drupal\gin_lb\TwigExtension\GinLbExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["page"] ?? null), "header", [], "any", false, false, true, 6), 6, $this->source), "html", null, true));
            echo "
        </div> <!--/.site-branding -->
      ";
        }
        ...
        ";
            ...
            <div class=\"menu-wrap\">
              ...
              ";
                // line 16
                echo $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->extensions['Drupal\gin_lb\TwigExtension\GinLbExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["page"] ?? null), "primary_menu", [], "any", false, false, true, 16), 16, $this->source), "html", null, true));
                echo "
            </div> <!-- /.menu-wrap -->
...
";
    ...
    {
        return new Source("", "@thex/template-parts/header/header.html.twig", "C:\\xampp\\htdocs\\causmic2\\themes\\thex\\templates\\template-parts\\header\\header.html.twig");
    }

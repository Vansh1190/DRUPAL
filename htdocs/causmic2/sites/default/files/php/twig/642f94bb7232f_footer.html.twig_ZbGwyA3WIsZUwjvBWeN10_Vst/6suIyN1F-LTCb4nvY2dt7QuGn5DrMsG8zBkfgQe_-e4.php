...
class __TwigTemplate_578f41cea735463a1210df5c4150aa48 extends Template
{
    private $source;
    private $macros = [];
...
";
        ...
        if (($context["scrolltotop_on"] ?? null)) {
            ...
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->sandbox->ensureToStringAllowed(($context["scrolltotop_icon_style"] ?? null), 31, $this->source)));
            echo "</div>
";
        }
        // line 33
        ...
        if (($context["fontawesome_four"] ?? null)) {
            // line 35
            echo "  ";
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->extensions['Drupal\gin_lb\TwigExtension\GinLbExtension']->escapeFilter($this->env, $this->extensions['Drupal\Core\Template\TwigExtension']->attachLibrary("thex/fontawesome4"), "html", null, true));
            echo "
";
        }
        // line 37
        if (($context["fontawesome_five"] ?? null)) {
            // line 38
            echo "  ";
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->extensions['Drupal\gin_lb\TwigExtension\GinLbExtension']->escapeFilter($this->env, $this->extensions['Drupal\Core\Template\TwigExtension']->attachLibrary("thex/fontawesome5"), "html", null, true));
            echo "
";
        }
        // line 40
        if (($context["bootstrapicons"] ?? null)) {
            // line 41
            echo "  ";
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->extensions['Drupal\gin_lb\TwigExtension\GinLbExtension']->escapeFilter($this->env, $this->extensions['Drupal\Core\Template\TwigExtension']->attachLibrary("thex/bootstrap-icons"), "html", null, true));
            echo "
";
        }
    }
    ...
    {
        return new Source("", "@edux/template-parts/footer.html.twig", "C:\\xampp\\htdocs\\causmic2\\themes\\edux\\templates\\template-parts\\footer.html.twig");
    }

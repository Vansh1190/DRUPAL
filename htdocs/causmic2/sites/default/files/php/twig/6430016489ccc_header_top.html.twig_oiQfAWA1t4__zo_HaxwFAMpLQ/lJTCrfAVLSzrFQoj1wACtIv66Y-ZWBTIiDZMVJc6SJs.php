...
class __TwigTemplate_afab534fcab6b8e814215ce74e68aa0f extends Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"header-top-container\">
      ";
        ...
        if (twig_get_attribute($this->env, $this->source, ($context["page"] ?? null), "header_top", [], "any", false, false, true, 4)) {
            ...
            ";
            // line 6
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->extensions['Drupal\gin_lb\TwigExtension\GinLbExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["page"] ?? null), "header_top", [], "any", false, false, true, 6), 6, $this->source), "html", null, true));
            echo "
        </div> <!--/.header-top-left -->
      ";
        }
...
";
    ...
    {
        return new Source("", "@tara/template-parts/header_top.html.twig", "C:\\xampp\\htdocs\\causmic2\\themes\\tara\\templates\\template-parts\\header_top.html.twig");
    }
